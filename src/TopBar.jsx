/* eslint react/no-unknown-property: ["error", { "ignore": ["xmlns:xlink"] }] */
/* Este comentario se puso porque era la única forma de que el logo de netflix no diera errores */
    ...
    <div className={styles["topbar-container"]}>
      <div className={styles["topbar-logo"]}>
        <svg
          ...
          aria-hidden="true"
          role="img"
          className={styles["topbar-logo-svg"]}
        >
          <g>
      ...
      <div className={styles["topbar-botones-container"]}>
        <div className={styles["topbar-boton-idioma-container"]}>
          <button
            type="button"
            className={styles["topbar-boton-idioma"]}
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={styles["topbar-planeta-svg"]}
              data-name="Globe"
            >
              <path
                fillRule="evenodd"
            ...
            <span className={styles["topbar-texto-idioma"]}>Español</span>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className={styles["topbar-flecha-svg"]}
              data-name="CaretDown"
              aria-hidden="true"
            >
              <path
          ...
          {mostrarListaIdiomas && (
            <ul className={styles["topbar-lista-idiomas"]}>
              <li>Español</li>
              <li>Inglés</li>
            </ul>
          )}
        </div>
        <button className={styles["topbar-button-inciar-sesion"]} type="button">
          <span className={styles["topbbar-button-inciiar-sesion-text"]}>
            Iniciar sesión
          </span>
        </button>
      </div>
