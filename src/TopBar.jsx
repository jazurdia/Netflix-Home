...
function TopBar() {
  ...
  return (
    <div className="topbar-container">
      ...
      <div className="topbar-botones-container">
        <div className="topbar-boton-idioma-container">
          <button
            type="button"
            className="topbar-boton-idioma"
          ...
          >
            ...
            <span className="topbar-texto-idioma">Español</span>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          {mostrarListaIdiomas && (
            <ul className="topbar-lista-idiomas">
              <li>Español</li>
              <li>Inglés</li>
            </ul>
          )}
